            ...
            <div key={p.id} className="group flex flex-col">
              <div className="aspect-[4/5] bg-gallery-stone mb-6 overflow-hidden relative">
                ...
                <button 
                  onClick={() => addItem(p)} 
                  disabled={p.stock < 1}
                  className="absolute bottom-0 left-0 w-full bg-gallery-ink text-white py-4 text-xs tracking-widest uppercase translate-y-full group-hover:translate-y-0 transition-transform duration-300 disabled:bg-gallery-subtle"
                >
